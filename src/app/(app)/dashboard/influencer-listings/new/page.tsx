...
export default function NewInfluencerListingPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      const res = await fetch("/api/influencer-listings", {
        method: "POST",
    ...
    <div className="mx-auto max-w-3xl px-4 py-10">
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            List a sponsorship opportunity for brands. Describe your content, set your expected quote (fixed price), or run an auction.
          </CardDescription>
        </CardHeader>
        <CardContent>
            ...
            <div className="space-y-4">
              <div>
                ...
                <p className="mt-1 text-sm text-muted-foreground">
                  Select content themes to help brands find your listing.
                </p>
              </div>
